                    ...
                    @foreach($cars as $car)
                        <div class="col-lg-4">
                            <div class="photo">
                                ...
                                <a href="{{ route('rent_view', ['id' => $car->id, 'title' => $car->model]) }}" class="rent-btn w-100 text-center">Book It</a>

                        </div>
                        <div class="col-lg-8">
                            <div class="display-table-cell">
                                <div class="car-list-info">
                                    <h2><a href="{{ route('car', ['id' => $car->id, 'title' => $car->model]) }}">{{ $car->model }}</a></h2>
