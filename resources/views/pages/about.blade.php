                    ...
                    <div class="testimonial-content">
                        ...
                        <div class="single-testimonial">
                            ...
                            <div class="client-logo">
                                <img src="{{ asset('img/client/client-pic-1.jpg') }}" alt="JSOFT">
                            </div>
                        </div>
                        ...
                        <div class="single-testimonial">
                            ...
                            <h3>Amader Tuni</h3>
                            <div class="client-logo">
                                <img src="{{ asset('img/client/client-pic-3.jpg') }}" alt="JSOFT">
                            </div>
                        </div>
                        <!--== Single Testimoial End ==-->
                        ...
                        <div class="single-testimonial">
                            ...
                            <div class="client-logo">
                                <img src="{{ asset('img/client/client-pic-2.jpg') }}" alt="JSOFT">
                            </div>
                        </div>
                        <!--== Single Testimoial End ==-->
                    </div>
